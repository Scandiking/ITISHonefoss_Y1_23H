...
#test1, test2, and test 3 variables.
...
#Display the average
print('The average score is', average)    #The average referred to in this line is the value of the average calculated in line 9.
